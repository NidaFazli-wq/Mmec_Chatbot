...
def api_query():
    ...
    offline_faq = [
        ...
        {"triggers": ["fees","fee","tuition","payment","payment details","fee structure"],
         "answer": "Fee structures vary by program and year. For general queries contact +91 9353364643 or info@mmec.edu.in. For exact fee breakup, check https://www.mmec.edu.in or request fee structure with your stream and year."},
